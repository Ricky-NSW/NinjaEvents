...
const AvatarUpload = ({ entityId, entityType, onAvatarUpload }) => {
    ...
    const handleAvatarUpload = () => {
        if (entityId && avatarFile) {
            ...
            const avatarRef = ref(storage, `${entityType}/${entityId}/avatar/temp/${avatarFile.name}`);
            ...
            uploadTask.on('state_changed',
                ...
                () => {
                    ...
                    getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
                        ...
                        const resizedAvatarRef = ref(storage, `${entityType}/${entityId}/avatar/${filename}_200x200.${extension}`);
            ...
            console.error("entityId or avatarFile is not set.");
        }
    };
